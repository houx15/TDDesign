...
export const OVERALL_STYLE_MOCKUPS: Record<string, string> = {
  ...
  "editorial-serif": [
    '<div style="width:100%;height:100%;background:{{background}};color:{{text}};padding:{{paddingMin}}px 32px {{paddingMin}}px 25%;box-sizing:border-box;font-family:{{fontFamily}}">',
  ...
  "brutalist-raw": [
    '<div style="width:100%;height:100%;background:{{background}};color:{{text}};position:relative;box-sizing:border-box;border-right:1px solid {{text}};border-bottom:1px solid {{text}};overflow:hidden;font-family:{{fontFamily}};padding:{{paddingMin}}px">',
    '<h1 style="font-family:{{fontFamily}};font-size:44px;text-transform:uppercase;line-height:0.95;letter-spacing:-0.02em;margin:0;margin-left:-8px">BUILT. NOT RENDERED.</h1>',
